...
public class UMLClassFigureTest {
	public static void main(String args[]) {
		...
		Label classLabel1 = new Label("Table",
				new Image(d, UMLClassFigureTest.class.getResourceAsStream("class_obj.gif")));
		...
		// Add attribute labels to both classes
		...
		// add method labels to both classes
		...
		// label next to the source (isEnd=false)
